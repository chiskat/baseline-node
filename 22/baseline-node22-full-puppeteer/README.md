# chiskat/baseline-node22-full-puppeteer

![](https://img.shields.io/docker/v/chiskat/baseline-node22-full-puppeteer?sort=semver) ![](https://img.shields.io/docker/image-size/chiskat/baseline-node22-full-puppeteer)
...
- 基于 `chiskat/baseline-node22-full` 并同步更新，预装 Chromium 以及相关依赖和字体（包括一套 Emoji 字体）；
