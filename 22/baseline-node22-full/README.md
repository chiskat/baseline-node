# chiskat/baseline-node22-full

![](https://img.shields.io/docker/v/chiskat/baseline-node22-full?sort=semver) ![](https://img.shields.io/docker/image-size/chiskat/baseline-node22-full)
...
- 基于 `node:22`，并通过 `corepack` 开启 `pnpm` 支持；
