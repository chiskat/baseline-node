# chiskat/baseline-node22-puppeteer

![](https://img.shields.io/docker/v/chiskat/baseline-node22-puppeteer?sort=semver) ![](https://img.shields.io/docker/image-size/chiskat/baseline-node22-puppeteer)
...
- 基于 `chiskat/baseline-node22` 并同步更新，预装 Chromium 以及相关依赖和字体（包括一套 Emoji 字体）；
