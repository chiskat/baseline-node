# chiskat/baseline-node24-full

![](https://img.shields.io/docker/v/chiskat/baseline-node24-full?sort=semver) ![](https://img.shields.io/docker/image-size/chiskat/baseline-node24-full)
...
- 基于 `node:24`，并通过 `corepack` 开启 `pnpm` 支持；
